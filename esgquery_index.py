...
#Tue Feb 19 16:09:25 PST 2013
#[durack1@crunchy cmip5]$ scp -p pcmdi6:/export/drach1/workbench/esg-publisher/src/python/esgcet/scripts/esgquery_index .
#durack1@pcmdi6's password:
#esgquery_index 100%   23KB  22.7KB/s   00:00

# Requires lxml to be installed locally - crunchy=OK ; oceanonly=TODO

# Demos
# [durack1@crunchy cmip5]$ esgquery_index.py --facets model -q project=CMIP5,variable=basin,latest=true,data_node=pcmdi9.llnl.gov -p
# [durack1@crunchy cmip5]$ esgquery_index.py --facets model -q project=CMIP5,variable=volcello -p

import sys
sys.path.append('/export/durack1/.local/lib/python2.7/site-packages/') ; # Add lxml to path 130315
import getopt
import string
import re
...
DEFAULT_QUERY_SERVICE = "http://pcmdi9.llnl.gov/esg-search/search"
DEFAULT_WGET_SERVICE = "http://pcmdi9.llnl.gov/esg-search/wget"
